  ...
  return (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-popover p-5 text-popover-foreground shadow-[var(--shadow-border-hover)] transition duration-300 ease-[var(--ease-out-smooth)]",
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute top-3 right-3 rounded-md p-2 text-muted-foreground">
          <X className="size-4" />
